...
function obtenerLargoDelArray(frutas) {
...
//   // Escribe tu código aquí:
 ...
 function cuentoElementos(letras) {
//   //Realiza una función que retorne la cantidad de los elementos del arreglo cuyo valor es mayor a 18.
//   //Escribe tu código aquí:
 console.log(letras.length)
 } 
cuentoElementos(letras)
...
//   //Escribe tu código aquí
 ...
 let elem = ["mundo", "playa", "casa", 25]
  function todosIguales(elem) {
...
todosIguales(elem)
 ...
 let meses =["noviembre", "julio", "enero", "abril", "agosto", "marzo"]
...
mesesDelAño(meses)
 ...
 let arr1 = [23, 111, 90, 150, 199, 7, 177, 0, 59]
 function mayorACien(arr1) {
 //   //La función recibe un array con enteros entre 0 y 200. Recorrer el array y guardar en un nuevo array sólo los
 //   //valores mayores a 100 (no incluye el 100). Finalmente devolver el nuevo array.
 //   // Tu código:
 let result = arr1.filter(arr1 => arr1 > 100)
  console.log(result); 
 }
mayorACien(arr1)
...
// No resuelvo los ejercicios siguientes porque estan repetidos.

//function devolverPrimerElemento(arr4) {
//   // Devuelve el primer elemento de un array
//   // Tu código:
//}

//function devolverUltimoElemento(cosas) {
//   // Devuelve el último elemento de un array
//   // Tu código:
//}
